...
class UpdFixedCol extends MutationCmd {
  ...
  boolean optimize(CommandExecServices svcs, OperationContext opctx, Detail detail)
  {
    if (opctx.deletedIds.contains(docUUID)) { log.dbg("UpdFixedCol filtered "+JSONUtil.serialize(this), null); return false }
    true
  }
...
class DelFixedCol extends MutationCmd {
  ...
  boolean optimize(CommandExecServices svcs, OperationContext opctx, Detail detail)
  {
    if (opctx.deletedIds.contains(docUUID)) { log.dbg("DelFixedCol filtered "+JSONUtil.serialize(this), null); return false }
    true
  }
...
class ClrFixedCol extends DelFixedCol {
  ...
  boolean optimize(CommandExecServices svcs, OperationContext opctx, Detail detail)
  {
    if (opctx.deletedIds.contains(docUUID)) { log.dbg("ClrFixedCol filtered "+JSONUtil.serialize(this), null); return false }
    true
  }
...
class UpdDocFixedColPAXOS extends MutationCmd {
  ...
  boolean optimize(CommandExecServices svcs, OperationContext opctx, Detail detail)
  {
    if (opctx.deletedIds.contains(docUUID)) { log.dbg("UpdDocFixedColPAXOS filtered "+JSONUtil.serialize(this), null); return false }
    true
  }
...
class NewAttr extends MutationCmd {
  ...
  boolean optimize(CommandExecServices svcs, OperationContext opctx, Detail detail)
  {
    if (opctx.deletedIds.contains(docUUID)) { log.dbg("NewAttr filtered "+JSONUtil.serialize(this), null); return false }
    true
  }
...
class UpdAttr extends NewAttr {
  ...
  boolean optimize(CommandExecServices svcs, OperationContext opctx, Detail detail)
  {
    if (opctx.deletedIds.contains(docUUID)) { log.dbg("UpdAttrCmd filtered "+JSONUtil.serialize(this), null); return false }
    if (opctx.deletedIdAttrs.contains(docUUID+attrName)) { log.dbg("UpdAttrCmd filtered from deleted attr "+JSONUtil.serialize(this), null); return false }
    true
  }
...
class DelAttr extends MutationCmd {
  ...
  boolean optimize(CommandExecServices svcs, OperationContext opctx, Detail detail)
  {
    if (opctx.deletedIds.contains(docUUID)) { log.dbg("DelAttr filtered "+JSONUtil.serialize(this), null); return false }
...
class ClrAttr extends DelAttr {
  ...
  boolean optimize(CommandExecServices svcs, OperationContext opctx, Detail detail)
  {
    if (opctx.deletedIds.contains(docUUID)) { log.dbg("ClrAttr filtered "+JSONUtil.serialize(this), null); return false }
    if (opctx.deletedIdAttrs.contains(docUUID+attrName)) { return false }
    true
  }
...
class ClrDocRels extends DelDocRels {
  ...
  boolean optimize(CommandExecServices svcs, OperationContext opctx, Detail detail)
  {
    if (opctx.deletedIds.contains(p1)) { log.dbg("ClrDocRels filtered "+JSONUtil.serialize(this), null); return false }
    return true
  }
...
class DelAttrRels extends MutationCmd {
  ...
  boolean optimize(CommandExecServices svcs, OperationContext opctx, Detail detail)
  {
    if (opctx.deletedIds.contains(p1)) { log.dbg("DelAttrRels filtered "+JSONUtil.serialize(this), null); return false }
    return true
  }
...
class ClrAttrRels extends DelAttrRels {
  ...
  boolean optimize(CommandExecServices svcs, OperationContext opctx, Detail detail)
  {
    if (opctx.deletedIds.contains(p1)) { log.dbg("ClrAttrRels filtered "+JSONUtil.serialize(this), null); return false }
    if (opctx.deletedIdAttrs.contains(p1+p2)) { log.dbg("ClrAttrRels filtered for attr "+JSONUtil.serialize(this), null); return false }
    return true
  }
